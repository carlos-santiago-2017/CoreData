...
- Core Data is a Database system that uses and Object Graph to store objects instead of single values. 
- This is a structure that comprises objects and their relationship.
...
- it is a definition of the type of objects the graph is going to contain (called Entities) and ther connections (called RelationShips)
